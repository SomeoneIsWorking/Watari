...
internal static partial class WebViewBridge
{
    ...
    [LibraryImport("native/macos/libwebview.dylib", EntryPoint = "WebView_SetEnableDevTools")]
    [UnmanagedCallConv(CallConvs = new Type[] { typeof(System.Runtime.CompilerServices.CallConvCdecl) })]
    public static partial void SetEnableDevTools(IntPtr handle, [MarshalAs(UnmanagedType.Bool)] bool enable);
}
